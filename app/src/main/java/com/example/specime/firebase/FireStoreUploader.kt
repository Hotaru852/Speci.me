...
//        )
        val questions = listOf(
            ...
            createQuestion(
                "Khi tôi nói chuyện với bạn bè, tôi thích nói đùa hơn nghe họ.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi muốn có càng nhiều dữ liệu & thông tin càng tốt trước khi quyết định một vấn đề.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi hay cười to hơn hầu hết mọi người xung quanh tôi.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi hay nói thằng vào những vấn đề tôi nghĩ, không quan tâm đến cảm xúc của người khác.",
                createLabel(3)
            ),
            createQuestion(
                "Tôi muốn mô tả mình như một người tự tin, vui tính và phản ứng kịp thời.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi luôn luôn lắng nghe cách mà người khác cảm nghĩ và xem xét cảm xúc của họ trước khi phát biểu ý kiến của mình.",
                createLabel(4)
            ),
            createQuestion(
                "Tôi quá quan tâm đến chi tiết trước khi quyết định một vấn đề.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi phải thừa nhận đôi khi tôi quá hách dịch.",
                createLabel(3)
            ),
            createQuestion(
                "Bạn tôi nói rằng tôi có thể bán nước đá cho Người Eskimos.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi được mô tả như là một người có tính kỷ luật cao & luôn luôn coi trọng kết quả.",
                createLabel(3)
            ),
            createQuestion(
                "Tôi có thể chỉ trích những người giải quyết công việc không có phương pháp hợp lý.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi rất lo âu nếu như tôi bị ép đáp ứng thời hạn cuối cùng.",
                createLabel(4)
            ),
            createQuestion(
                "Tôi thích một mình hơn là phải dính líu với người khác.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi là một người bình tĩnh và điềm đạm, luôn quan tâm đến cảm nghỉ của người khác.",
                createLabel(4)
            ),
            createQuestion(
                "Tôi thích làm việc trong một môi trường có thể tiên đoán trước, có hệ thống, không bị rượt đuổi.",
                createLabel(4)
            ),
            createQuestion(
                "Tôi rất giỏi thuyết phục người khác làm theo ý mình.",
                createLabel(1)
            ),
            createQuestion(
                "Mọi người đánh giá tôi là người cầu toàn.",
                createLabel(2)
            ),
            createQuestion(
                "Có uy quyền và chức vụ cao thì rất quan trọng với tôi.",
                createLabel(3)
            ),
            createQuestion(
                "Về lâu dài, tôi xem tính hợp lý quan trọng hơn tình cảm.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi mạnh dạn áp đặt người khác theo ý mình, mặc dù người khác không thích.",
                createLabel(3)
            ),
            createQuestion(
                "Tôi được mô tả như là một người đều đặn, hoàn chỉnh và có óc phân tích.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi bị thu hút vào những ý tưởng mạo hiểm hơn là những thói quen hàng ngày.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi phải thừa nhận rằng khi tôi ở trong nhóm, tôi là người nói nhiều nhất.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi là người bình tĩnh, kiên nhẫn và yên lặng.",
                createLabel(4)
            ),
            createQuestion(
                "Tôi phải thừa nhận răng có một số người đã xem tôi như một người trầm tĩnh và lãnh đạm.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi thích làm theo tinh thần đồng đội.",
                createLabel(3)
            ),
            createQuestion(
                "Tôi hay tránh né những người xông xáo và quyết đoán.",
                createLabel(4)
            ),
            createQuestion(
                "Hầu hết mọi người xem tôi như là một người hiểu biết và sẵn sàng chia sẻ niềm vui và nỗi buồn của người khác.",
                createLabel(4)
            ),
            createQuestion(
                "Tôi hay kiềm chế biểu lộ tình cảm của mình.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi được xem như là người nhiệt tình, thân mật luôn lắng nghe người khác.",
                createLabel(4)
            ),
            createQuestion(
                "Tôi không gặp vấn đề trong việc biểu hiện cảm xúc, ý kiến tại các cuộc họp tập trung vào thảo luận.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi thích lắng nghe hơn là nói chuyện.",
                createLabel(4)
            ),
            createQuestion(
                "Đứng lên, và nói chuyện với đám động về điều bạn tâm đắc thật thú vị.",
                createLabel(1)
            ),
            createQuestion(
                "Vào cuối ngày, kết quả công việc là điều tôi quan tâm nhất,  không cần nghĩ người khác đang suy nghĩ gì và cảm thấy thế nào.",
                createLabel(3)
            ),
            createQuestion(
                "Tôi sẵn lòng nghe những vấn đề của người khác.",
                createLabel(4)
            ),
            createQuestion(
                "Tôi trông cậy vào quyết định riêng của tôi hơn là lắng nghe ý kiến của người khác.",
                createLabel(3)
            ),
            createQuestion(
                "Tôi diễn tả nhiều bằng tay khi tôi bị kích động.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi phải thừa nhận rằng tôi không tự tin khi tôi gặp người lạ.",
                createLabel(4)
            ),
            createQuestion(
                "Tôi hay cường điệu & trau chuốt khi tôi kể chuyện cho bạn tôi nghe.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi thường sẵn sàng nhượng bộ những gì mà người khác muốn ở tôi.",
                createLabel(4)
            ),
            createQuestion(
                "Tôi hay tránh làm những quyết định khó.",
                createLabel(4)
            ),
            createQuestion(
                "Khi tôi giận, mọi người nghe tôi.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi tìm thấy tôi hay có khuynh hướng kiểm soát mọi tình huống của tôi và người khác.",
                createLabel(3)
            ),
            createQuestion(
                "Tôi là người hay xung phong trước.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi hay là người làm theo ý người khác hơn là lãnh đạo người khác.",
                createLabel(4)
            ),
            createQuestion(
                "Cấu trúc, quy định và thủ tục rất quan trọng đối với tôi.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi cố gắng bàn bạc vấn đề mới, khác & thách thức.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi có sức cạnh tranh cao.",
                createLabel(3)
            ),
            createQuestion(
                "Tôi là người quyết định vấn đề rất nhanh lẹ.",
                createLabel(3)
            ),
            createQuestion(
                "Tôi là một người chi tiết.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi hay nhút nhát và kín đáo.",
                createLabel(4)
            ),
            createQuestion(
                "Tôi thích làm những điều mới, ngay cả điều mạo hiểm.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi rất chắc chắn và tự tin trong mọi tình huống.",
                createLabel(3)
            ),
            createQuestion(
                "Tôi hay bị làm hoảng sợ và sợ hãi khi hành động và làm quyết định theo ý mình.",
                createLabel(4)
            ),
            createQuestion(
                "Tôi không gặp rắc rối khi ra những quyết định nhanh và quan trọng.",
                createLabel(3)
            ),
            createQuestion(
                "Tôi là người hay bị dính vào những chi tiết cụ thể.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi rất cởi mở để chia sẻ điều mà tôi đang nghĩ.",
                createLabel(1)
            ),
            createQuestion(
                "Trong thảo luận, tôi luốn kéo người khác theo đúng hướng để không lãng phí thời gian - thậm chí họ không thích nó.",
                createLabel(3)
            ),
            createQuestion(
                "Tôi hay giấu cảm xúc của mình khi bị xúc phạm.",
                createLabel(4)
            ),
            createQuestion(
                "Tôi thấy phiền lòng với người coi thường tình huống nghiêm trọng.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi là người hòa nhã và dễ chịu.",
                createLabel(4)
            ),
            createQuestion(
                "Tôi gọn gàng, có tổ chức, và ngăn nắp khi làm bất cứ điều gì.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi muốn một phần của cuộc đời bạn trao cho tôi.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi là người kiểm soát, tự tin và dũng cảm.",
                createLabel(3)
            ),
            createQuestion(
                "Tôi rất dễ bị ảnh hưởng bởi ý kiến & gợi ý của người khác.",
                createLabel(4)
            ),
            createQuestion(
                "Tôi dễ bị nổi cáu bởi người muốn rượt đuổi tôi.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi thích đọc hơn nói.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi phải thừa nhận rằng tôi là một người tham công tiếc việc.",
                createLabel(3)
            ),
            createQuestion(
                "Cảm xúc của con người ít quan trọng hơn hoàn thành việc đúng giờ.",
                createLabel(3)
            ),
            createQuestion(
                "Tôi thấy rất ngột ngạt khi phải làm đúng thủ tục, có hệ thống và kế hoạch cụ thể.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi thích làm trung tâm chú ý trong nhóm.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi phải thừa nhận rằng một số người tìm thấy tôi quá thẳng tính và không ngoại giao thỉnh thoảng.",
                createLabel(3)
            ),
            createQuestion(
                "Tôi có khuynh hướng bất ddoognf khi nghe hoặc xem một tin gì đó mà tôi không thấy thích.",
                createLabel(3)
            ),
            createQuestion(
                "Tôi phải mất hơn 10 phút để làm bản câu hỏi này.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi được mô tả là người thanh thản, phụ thuộc và dễ chịu.",
                createLabel(4)
            ),
            createQuestion(
                "Tôi thích theo những truyền thống và tập quán được chấp nhận.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi thích làm việc với những dữ liệu, con số hơn là con người.",
                createLabel(2)
            ),
            createQuestion(
                "Tôi có thể suy nghĩ kỹ và thực hiện những ý tưởng & khái niệm mới.",
                createLabel(1)
            ),
            createQuestion(
                "Tôi nổi tiếng cứng rắn và kiên quyết khi làm việc với con người và vấn đề.",
                createLabel(3)
            )
        )
    ...
    private fun createLabel(category: Int): String {
